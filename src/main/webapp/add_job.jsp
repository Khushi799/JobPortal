...
>>>>>>> f2b47f03144159f24b7a7c62fd0408c2a2a1168b
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
        ...
        <div class="col-md-10 offset-md-1">
            <div class="card mt-3"
                ...
                <div class="card-body">
                    ...
                    <!-- IMPORTANT: match form action with your servlet mapping -->
			...
			<div class="card mt-3" style="box-shadow: 8px 9px 19px -10px rgba(33, 37, 41, 1);">
				<div class="card-body">
					...
					<form action="add_job" method="post">
						...
						<button type="submit" class="btn btn-success mt-3">Publish Job</button>
					</form>
				</div>
			</div>
		</div>
