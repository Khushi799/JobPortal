	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<form class="d-flex" role="search">
				<c:if test="${userobj.role eq 'admin'}">
					<a href="#" class="btn btn-light me-2" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
				...
				<c:if test="${userobj.role eq 'user'}">
					<a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"
						class="btn btn-light me-2"><i class="fa-solid fa-user"></i>
						${userobj.name}</a>
					<a href="logout" class="btn btn-light"><i
						class="fa-solid fa-power-off"></i> Logout</a>
				</c:if>
				...
				<c:if test="${empty userobj}">
					<a href="login.jsp" class="btn btn-light me-2"><i
